...
public class PlataHetaWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(PlataHetaWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/PlataHetaWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/PlataHetaWLAIW/InitOutcome.xml").getDocumentElement();
